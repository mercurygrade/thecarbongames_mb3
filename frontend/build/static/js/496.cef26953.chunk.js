"use strict";
(self.webpackChunkthecarbongames = self.webpackChunkthecarbongames || []).push([
  [496],
  {
    1496: function (n, e, t) {
      t.r(e),
      ...
      var r,
              ...
              n.forEach(function (n) {
                "first-contentful-paint" === n.name &&
                  ...
                  n.startTime < i.firstHiddenTime &&
                    ((o.value = n.startTime - d()), o.entries.push(n), t(!0)));
              });
            },
            u =
              window.performance &&
        ...
        A = function (n, e) {
          r ||
            ((r = e), (i = n), (o = new Date()), P(removeEventListener), F());
        },
        F = function () {
          if (i >= 0 && i < o - S) {
            var n = {
        ...
        N = function (n) {
          n.forEach(function (n) {
            n.interactionId &&
              ((D = Math.min(D, n.interactionId)),
              (M = Math.max(M, n.interactionId)),
              (B = M ? (M - D) / 7 + 1 : 0));
          });
        },
        R = function () {
          return u ? B : performance.interactionCount || 0;
        },
        q = function () {
        ...
        _ = function (n) {
          var e = O[O.length - 1],
            t = j[n.interactionId];
          if (t || O.length < 10 || n.duration > e.latency) {
            if (t)
            ...
            O.sort(function (n, e) {
              ...
              O.splice(10).forEach(function (n) {
                delete j[n.id];
              });
          }
        },
        z = function (n, e) {
          ...
          var r,
            ...
            o = function (n) {
              ...
              var e,
                t = ((e = Math.min(O.length - 1, Math.floor(x() / 50))), O[e]);
              t &&
                t.latency !== i.value &&
                ((i.value = t.latency), (i.entries = t.entries), r());
            },
            a = p("event", o, { durationThreshold: e.durationThreshold || 40 });
        ...
        J = function (n, e) {
          ...
          if (u) {
            ...
            var c = function () {
              G[o.id] ||
                (a(u.takeRecords()), u.disconnect(), (G[o.id] = !0), t(!0));
            };
            ["keydown", "click"].forEach(function (n) {
              addEventListener(n, c, { once: !0, capture: !0 });
            }),
              v(c, !0),
              f(function (i) {
                (o = l("LCP")),
...
//# sourceMappingURL=496.cef26953.chunk.js.map
